...
public class EmployStuEditManageDialog extends JDialog {
	...
	public EmployStuEditManageDialog(EmployStuManageDialog esmd, EmployStuManageVO esmVO, boolean flag) {
		...
		jlblImg = new JLabel(new ImageIcon("C:/Users/user/git/course_prj2/course_prj2/src/dev/workspace/course_ysy/src/kr/co/sist/course/images/user.png"));
		JLabel jlblback = new JLabel(
				new ImageIcon("C:/Users/user/git/course_prj2/course_prj2/src/dev/workspace/course_ysy/src/kr/co/sist/course/images/editBackground.png"));
